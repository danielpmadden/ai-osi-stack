...
records, the runtime witnesses supply signatures, and the civic public reads the trail without a proprietary viewer. The
...
paired with a deterministic check described in AEIP version 1.3 (\texttt{aeip\_version=1.3}).
}
...
metadata, temporal seals, and custodial witnesses. Third, the verification automation (see
\texttt{scripts/generate-tex-tables.py}) renders a control table that lists purpose, obligations, artefacts, and evidence fields
