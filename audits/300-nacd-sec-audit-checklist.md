...
- [ ] Ethics principles align with IEEE Ethically Aligned Design guidance.
- [ ] EU AI Act readiness considerations documented in board brief or risk register.
- [ ] Privacy overlays align with GDPR/CCPA obligations in data controls.

## Risk Register Completeness
- [ ] Risk categories cover data, model, prompt, supply chain, and communications.
...
- [ ] 72-hour decision timeline documented.
- [ ] Investigation data handling respects privacy/IP boundaries.
- [ ] Communications plan covers internal, customer, regulator, investor audiences.
- [ ] Post-incident governance updates required.
...
- [ ] Due diligence questionnaire completed for critical vendors.
- [ ] Contract guardrails include SLAs, indemnities, and termination clauses.
- [ ] Monitoring cadence defined (quarterly/annual).
- [ ] Shadow AI policy communicated to employees.

## Controls Catalog Coverage Gaps
- [ ] Each OSI layer documented with objectives, activities, evidence, validation, dependencies.
- [ ] Assurance methods matrix aligns with control descriptions.
