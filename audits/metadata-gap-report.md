...
- dashboard/src/utils/aeipUtils.ts:L3 — Comment notes "// TODO: Replace static stubs with AEIP client once protocol bindings are available." [TODO][PLACEHOLDER]
- dashboard/src/utils/types.ts:L3 — Comment documents "// TODO: Extend with runtime fetch typing once AEIP/OpenAI integrations are enabled." [TODO][PLACEHOLDER]
- dashboard/src/utils/accessibility.ts:L3 — Comment states "// TODO: Integrate automated WCAG validation and T-SIR translation fidelity checks." [TODO]
- dashboard/src/components/ArtifactGallery.tsx:L69 — UI copy embeds "// TODO: attach AEIP provenance modal trigger" placeholder. [TODO][PLACEHOLDER]
- dashboard/src/components/GlossaryDrawer.tsx:L85 — UI copy carries "// TODO: integrate hover tooltips across dashboard via glossary API". [TODO]
- dashboard/src/components/VersionTimeline.tsx:L48 — Component footer reads "// TODO: connect to temporal integrity ledger for playback." [TODO]
- dashboard/src/components/IntegrityBadge.tsx:L22 — Badge caption includes "// TODO: embed ledger verification." [TODO]
- dashboard/src/components/AEIPLogViewer.tsx:L40 — Modal guidance retains "// TODO: hydrate from AEIP spine API." [TODO]
- dashboard/src/pages/About.tsx:L14-L16 — Roadmap list enumerates pending actions marked "// TODO" without public context. [TODO]
- dashboard/src/components/LayerCard.tsx:L108-L124 — Placeholder labels such as "No documented risks," "Standards pending," "Artifacts forthcoming," and "Hook mapping pending" signal incomplete data population. [PLACEHOLDER][VERIFY]
- dashboard/README.md:L81 — Maintainer note "// TODO: integrate live AEIP, persona, and governance APIs when ratified" requires resolution or scoping note. [TODO]
- dashboard/docs/component-map.md:L14 — Table entry flags "TODO for conformance reports" in `About` page description. [TODO]
- dashboard/docs/accessibility-checklist.md:L16,L26,L31 — Checklist retains three unchecked TODO items for analytics logging, glossary hovers, and provenance sync. [TODO]
...
- docs/zenodo-metadata.yaml:L7-L14 — Metadata still describes v4 release, lists version "v4-protocol-blueprint," and uses placeholder publication date "2025-11-XX." [VERSION][DATE][VERIFY]
