...
- **Integrity Manifest:** [`meta/v5-manifest.yaml`](v5-manifest.yaml)
...
```
meta/                  → Canonical README, integrity notices, manifests, licensing, changelog
ops/                   → Operational tooling (Makefile, pre-commit hooks, CI workflows, gitignore)
source/                → LaTeX source for canonical specification
source/interpretive/   → Chapters 19A–24 (Interpretive Canon)
govspine/              → Python runtime package (implementation spine and evidence store)
...
For orientation from the repository root, `meta/README.md` is now a short pointer to this canonical documentation at `meta/README.md`.
