...
```mermaid
flowchart LR
  Intake[Evidence Intake] --> Crosswalk[Standards Crosswalk]
  Crosswalk --> Package[Disclosure Packaging]
  Package --> Release[Public Release Channels]
  Release --> Feedback[Civic Feedback Loop]
  Feedback --> Intake
```
