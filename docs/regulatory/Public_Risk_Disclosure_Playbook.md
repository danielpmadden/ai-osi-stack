...
# Public Risk Disclosure Playbook for AI and Cyber Risk
...
5. **File (if Material)**: Submit required market disclosures or update annual filings as required; coordinate investor relations messaging.
...
## Statutory Risk Disclosure Cross-Reference
| Topic | Repo Coverage | Summary |
| --- | --- | --- |
| Board oversight expectations | `docs/regulatory/BOARD_BRIEF_GOVERNANCE_ALIGNMENT.md`, `docs/regulatory/Board_Charter_Addendum_AI_Oversight.md` | Outlines oversight roles, committee delegations, and cadence.
| Risk management narrative | `docs/regulatory/Controls_Catalog_by_Layer.md`, `docs/regulatory/AI_Risk_Register.md` | Describes control families and risk mitigation narrative for AI-specific threats.
| Management responsibilities | `docs/regulatory/Incident_Response_and_Materiality_Guide.md`, `docs/regulatory/Training_and_Awareness_for_Board_and_Execs.md` | Details management processes for incident handling, training, and governance updates.
| Enterprise risk factors | `docs/regulatory/AI_Risk_Register.md`, `docs/regulatory/Disclosure_Language_Safe_Harbor_Samples.md` | Provides narrative risks and sample disclosure language.
