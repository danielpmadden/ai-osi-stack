...
\textit{Licensed under Creative Commons Attribution–NonCommercial–NoDerivatives 4.0 International (CC BY-NC-ND 4.0)}\\[0.75em]
...
Custodians SHALL maintain version hashes within the AEIP integrity
...
record with verifiable signature and timestamp.  
...
Each version gets saved with a date and signature so people can
...
\begin{enumerate}
  ...
  \item \textbf{Counter-Signatures.}  
        Each justification artifact SHALL bear at least one
        custodian or peer signature confirming review and
        reasonableness.
\end{enumerate}
...
custodian signatures, and rationale for change.  
...
interactions involving AI systems compliant with this
...
signatures asserting compliance with agreed governance clauses.  
